...
RSpec.describe 'Artists songs index' do
  before :each do
    ...
    @purple = @prince.songs.create!(title: "Purple Rain", length: 234, play_count: 223423)
    @beret = @prince.songs.create!(title: "Rasberry Beret", length: 534, play_count: 74747)
  end
  it 'shows all of the songs of the songs for the artist' do
  ...
  it 'shows the average song length for the artist' do
    ...
    expect(page).to have_content("Average Song Length for Prince: 384")
  end
end